    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hall', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.examhall')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('kt', 'KT Application'), ('revaluation', 'Revaluation Application'), ('general', 'General')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_marks', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exam_subjects', to='main_app.exam')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.subject')),
            ],
            options={
